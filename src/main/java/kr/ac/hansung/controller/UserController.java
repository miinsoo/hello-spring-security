...
public class UserController {
    ...
    public String passwordChange(@AuthenticationPrincipal UserDetails userDetails,
        ...
        if (!dto.getNewPassword().equals(dto.getConfirmPassword())) {
            bindingResult.rejectValue("confirmPassword", "mismatch", "새 비밀번호와 확인 비밀번호가 일치하지 않습니다");
            return "user/password";
        }
        try {
